...
| ER-005 | project-local | `docs/joint_training/goals/experiment-execution-core-consolidation/plan.md` | The 8K shared profile is specific to the current Stage123 experiment. |
| ER-006 | project-local | `docs/joint_training/goals/experiment-execution-core-consolidation/plan.md` | Human decision policy is specific to this Goal and guarded notification flow. |
