---
title: "方案：On-Policy Weak-Driven SFT（正向+反向）"
status: active
tags: [domain/weak-driven, method/on-policy, method/logits-fusion, content/theory, lifecycle/process]
created: 2026-04-05
modified: 2026-04-05
project: weak-driven-learning
phase: exploration
related: []
---
## 方案：On-Policy Weak-Driven SFT（正向 + 反向）
