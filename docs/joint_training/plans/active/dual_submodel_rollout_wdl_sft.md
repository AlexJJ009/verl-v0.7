...
- Status: **IMPLEMENTED, BUT 3A REAL TRAINING FAILED AS METHOD-LEVEL NEGATIVE RESULT**
- Created: 2026-04-27
...
> `docs/joint_training/plans/active/dual_submodel_rollout_wdl_sft_3a_failure_analysis.md`
