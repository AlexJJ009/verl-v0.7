...
| `experiment_execution_reliability_goal.md` | Pending independent review | Serial Goal plan for scorer/rollout preflight estimation, manifest-native queue/monitor/release workflows, and trigger/action/failure engineering-rule migration. |
