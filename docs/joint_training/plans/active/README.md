...
| `experiment_execution_reliability_goal.md` | Architecture consolidation pending independent review | Stop framework expansion, restore generic trainer and manifest boundaries, replace brittle source-text tests, collapse receipts/documents, and require a negative line budget before GPU calibration can resume. |
