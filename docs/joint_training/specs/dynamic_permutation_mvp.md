...
- focused Dynamic Permutation, actor/config plumbing, checkpoint/no-op, and hardened Slurm-contract gate: `113 passed` in the offline CPU harness with `CUDA_VISIBLE_DEVICES=""`; the wrapper-specific executable/static subset is `18 passed`;
