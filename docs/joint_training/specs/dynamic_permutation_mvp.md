...
- focused Dynamic Permutation, actor/config plumbing, checkpoint/no-op, and Slurm-contract gate: `93 passed` in the offline CPU harness with `CUDA_VISIBLE_DEVICES=""`;
