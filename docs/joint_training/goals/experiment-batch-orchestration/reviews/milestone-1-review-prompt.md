...
- Applicable ACs: `AC-01,AC-02,AC-04,AC-06,AC-09`
...
Review the committed Milestone 1 schema and core contract adversarially. Verify no batch retry/resume, immutable admission/implementation binding, deterministic control replay/CAS behavior, ordered fallback state/events, and preservation of legacy atomic behavior. Do not implement.
