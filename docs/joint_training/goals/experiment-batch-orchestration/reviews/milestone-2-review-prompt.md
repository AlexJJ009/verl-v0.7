...
- Applicable ACs: `AC-01,AC-02,AC-03,AC-04,AC-05,AC-06,AC-09`
...
Adversarially review production batch validation/routing/control from committed state. Probe restart-safe control cursor, stale/replay CAS, immutable protected/admission bindings, no retry/resume, completed_with_failures exit semantics, local fallback, repeated-failure stop, cleanup failure stop, and operator stop/pause/continue. Do not implement.
