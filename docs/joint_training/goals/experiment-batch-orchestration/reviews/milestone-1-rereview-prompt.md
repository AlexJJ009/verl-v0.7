...
Focused same-reviewer rereview of F-M1-01 only. Verify stop_now issued after item_started and during active polling terminates the active child, prevents the next item, records the control, and cannot fall forward or retry. Do not implement.
