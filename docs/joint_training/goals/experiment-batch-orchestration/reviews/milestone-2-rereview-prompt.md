...
- Applicable ACs: `AC-03,AC-05,AC-06`
...
Same-reviewer focused rereview of F-M2-01. Reproduce the control-poll/child-success race and verify control CAS is accepted at running revision, active terminal item evidence is persisted, no next item starts, and final state is stopped. Do not implement.
