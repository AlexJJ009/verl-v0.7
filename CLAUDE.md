...
| `plans/active/qwen3_1p7b_wdl_mechanism_program.md` | **Qwen3-1.7B WDL mechanism program** — fixed-M1 common n=256 and DynPerm rho=0/0.25/0.5 P60 are complete; rho=1 Standard-C completed/fixed-M1 failed; the lambda 0.7/0.9 C/D0/fixed-M1 online factorial is complete, while low-LR controls remain incomplete; Align/true-Random/Anti geometry controls are designed but not implemented | LAMBDA FACTORIAL COMPLETE ONLINE / OFFLINE + MULTI-SEED NEXT |
