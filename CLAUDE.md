...
| `plans/active/experiment_execution_reliability_goal.md` | **Experiment execution reliability Goal** — scorer/rollout preflight estimation, manifest-native queue/monitor/release generation, and trigger/action/failure engineering-rule audit | PENDING INDEPENDENT REVIEW |
