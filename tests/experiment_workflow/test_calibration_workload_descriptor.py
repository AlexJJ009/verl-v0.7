...
def test_qwen3_1p7b_parameter_counter_matches_pinned_config():
    module = load()
    config = Path("/data-1/.cache/huggingface/hub/models--Qwen--Qwen3-1.7B/snapshots/70d244cc86ccca08cf5af4e1e306ecf908b1ad5e/config.json")
...
def test_qwen3_counter_rejects_attention_shape_mismatch(tmp_path):
    module = load()
    config = {
        "model_type": "qwen3", "vocab_size": 100, "hidden_size": 64, "intermediate_size": 128,
        "num_hidden_layers": 2, "num_attention_heads": 3, "num_key_value_heads": 1,
        "head_dim": 16, "tie_word_embeddings": True, "attention_bias": False,
    }
