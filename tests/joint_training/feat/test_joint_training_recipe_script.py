...
def test_joint_training_recipe_uses_vllm_rollout_and_no_sync_mode():
    ...
    assert 'DEFAULT_CKPT_BASE_DIR_PRIMARY="/data-1/checkpoints/JointTraining/GRPO"' in script
    ...
    assert 'DEFAULT_CKPT_BASE_DIR_FALLBACK="/data-2/checkpoints/JointTraining/GRPO"' in script
    ...
    assert "using ${BASE_CKPT_DIR} instead." in script
